...
class FolderStrategyTest extends TestCase
{
    ...
    public function testGetFilePathWithNoTags(): void
    {
    ...
    public function testGetFilePathWithFolderTags(): void
    {
        $measurement = 'cpu_usage';
        $tags = [
            'region' => 'us-east',
    ...
    public function testGetFilePathWithMissingFolderTags(): void
    {
        $measurement = 'cpu_usage';
        $tags = [
            'region' => 'us-east',
    ...
    public function testResolveFilePathsWithNoConditions(): void
    {
    ...
    public function testResolveFilePathsWithTagConditions(): void
    {
        // Create test directory structure and files
        mkdir($this->baseDir . 'us-east/server1', 0777, true);
        mkdir($this->baseDir . 'us-west/server2', 0777, true);
    ...
    public function testFindMeasurementsByTags(): void
    {
        // Create test directory structure and files
        mkdir($this->baseDir . 'us-east/server1', 0777, true);
        mkdir($this->baseDir . 'us-west/server2', 0777, true);
    ...
    public function testResolveFilePathsWithComplexConditions(): void
    {
        // Create test directory structure and files
        mkdir($this->baseDir . 'us-east/server1', 0777, true);
        mkdir($this->baseDir . 'us-west/server2', 0777, true);
    ...
    public function testOptimizedSearchPath(): void
    {
        // Create test directory structure and files
        mkdir($this->baseDir . 'us-east/server1', 0777, true);
        mkdir($this->baseDir . 'us-west/server2', 0777, true);
